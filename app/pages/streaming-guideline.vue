  ...
  <div class="wrapper">
    <div class="inner">
      <hgroup class="pageTtl">
        <h1 class="en">STREAMING GUIDELINE</h1>
        <p class="ja">ゲームの配信に関するガイドラインについて</p>
      </hgroup>
...
const contentId: string = 'streaming-guideline'
...
useSeoMeta({
  title: `ゲームの配信に関するガイドライン | ${inject('globalSiteName')}`,
  ogTitle: `ゲームの配信に関するガイドライン | ${inject('globalSiteName')}`,
  ogUrl: `${inject('globalSiteUrl')}/streaming-guideline/`,
})
</script>
