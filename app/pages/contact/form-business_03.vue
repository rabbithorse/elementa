<template>
  <div class="wrapper">
    <hgroup class="pageTtl">
      ...
      <p class="ja">その他・総合お問い合わせ</p>
    </hgroup>

    <div class="notes">
      <p>法人様から弊社へのその他のお問い合わせは、下記のフォームよりお願いいたします。</p>
    </div>
...
useSeoMeta({
  title: `その他・総合お問い合わせ | お問い合わせ | ${inject('globalSiteName')}`,
  ogTitle: `その他・総合お問い合わせ | お問い合わせ | ${inject('globalSiteName')}`,
  ogUrl: `${inject('globalSiteUrl')}/contact/form-business_03/`,
})
</script>
