<template>
  <div class="wrapper">
    ...
    <div class="notes">
      <p>業務提携やサービスのご提案は、下記のフォームよりお願いいたします。</p>
    </div>
...
useSeoMeta({
  title: `事業のご提案 | お問い合わせ | ${inject('globalSiteName')}`,
  ogTitle: `事業のご提案 | お問い合わせ | ${inject('globalSiteName')}`,
  ogUrl: `${inject('globalSiteUrl')}/contact/form-business_02/`,
})
</script>
