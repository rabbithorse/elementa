  ...
  <div class="wrapper">
    <div class="inner">
      <hgroup class="pageTtl">
        <h1 class="en">CUSTOMER HARASSMENT POLICY</h1>
        <p class="ja">カスタマーハラスメントへの対応方針について</p>
      </hgroup>
...
const contentId: string = 'customer-harassment-policy'
...
useSeoMeta({
  title: `カスタマーハラスメントへの対応方針 | ${inject('globalSiteName')}`,
  ogTitle: `カスタマーハラスメントへの対応方針 | ${inject('globalSiteName')}`,
  ogUrl: `${inject('globalSiteUrl')}/customer-harassment-policy/`,
})
</script>
